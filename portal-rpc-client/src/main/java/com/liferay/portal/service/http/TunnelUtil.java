...
public class TunnelUtil {
	...
	public static Key getSharedSecretKey() throws AuthException {
		String sharedSecret = PropsUtil.get(PropsKeys.TUNNELING_SERVLET_SHARED_SECRET);
	...
	private static final boolean _VERIFY_SSL_HOSTNAME = false;  /*GetterUtil.getBoolean(
