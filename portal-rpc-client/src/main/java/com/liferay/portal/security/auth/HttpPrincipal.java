...
/// We will do without digested passwords, because this would pull in a huge number 
/// of dependencies not used anywhere else, and its not really needed by an API
