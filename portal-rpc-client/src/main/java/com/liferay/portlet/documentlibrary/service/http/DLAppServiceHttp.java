...
public class DLAppServiceHttp {
	public static com.liferay.portal.kernel.repository.model.FileEntry addFileEntry(
		...
		try {
			...
			return (com.liferay.portal.kernel.repository.model.FileEntry)Tunneling.invoke(httpPrincipal, methodHandler);
    ...
    try {
      ...
      _log.error(ex, ex);
      throw new PortalException("Unable to read from input file", ex);
    }
	}
    ...
    try {
      ...
      _log.error(ex, ex);
      throw new PortalException("Unable to read from input stream", ex);
    }
	}
	...
	public static com.liferay.portlet.documentlibrary.model.DLFileShortcut addFileShortcut(
		...
		try {
			...
			return (com.liferay.portlet.documentlibrary.model.DLFileShortcut)Tunneling.invoke(httpPrincipal, methodHandler);
		}
	...
	public static com.liferay.portal.kernel.repository.model.Folder addFolder(
		...
		try {
			...
			return (Folder)Tunneling.invoke(httpPrincipal, methodHandler);
		}
		catch (SystemException se) {
			_log.error(se, se);
			throw se;
	...
	public static void cancelCheckOut(HttpPrincipal httpPrincipal,
		...
		try {
			...
			Tunneling.invoke_void(httpPrincipal, methodHandler);
		}
		catch (SystemException se) {
			_log.error(se, se);
			throw se;
	...
	public static com.liferay.portal.kernel.repository.model.FileEntry checkOutFileEntry(
		...
		try {
			...
			return (FileEntry)Tunneling.invoke(httpPrincipal, methodHandler);
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
			throw se;
	...
	public static java.util.List<com.liferay.portal.kernel.repository.model.FileEntry> getFileEntries(
		...
		try {
			...
			return (List<FileEntry>)Tunneling.invoke(httpPrincipal, methodHandler);
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
			throw se;
...
/*  Removed, because trying to call the above method with a null value in parameter "bytes"
    leads to an ambiguous reference. The above methods signature is then indisdinguishable from this one.
    TODO: There may be more cases like this in this library.
