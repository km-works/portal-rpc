...
public class DLFileEntryServiceHttp {
  ...
  public static byte[] getFileAsBytes(HttpPrincipal httpPrincipal, 
          long fileEntryId, 
          String version) 
      throws PortalException, SystemException {
    
    return RPCExtensionsHttp.getFileAsBytes(Configuration.getToken(), 
            fileEntryId, version);
  }
    ...
    return RPCExtensionsHttp.getFileAsStream(Configuration.getToken(), 
            fileEntryId, version);
	}
